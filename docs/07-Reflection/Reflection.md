...
Given the circumstances, I was able to fulfill majority of the individual requirements such as having the OLED work alongside the buttons to have a HMI aspect of the project. The only main thing I missed was the coding portion and having certain components be SMD as I lost points with sending messages(which I was able to get in the showcase) and having to use through-hole components like the diodes, inductors, and capacitors.

## Microcontroller/Module Startup Tip

* I wish I knew the coding portion sooner than later
* Being patient is key
* Use your resources
* Knowing how to link power correctly, so that certain parts worked when powered.
